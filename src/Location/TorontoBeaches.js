...
const TorontoBeaches = () => {
  return (
    <>
      <div className="breadcumb">
        <div className="text-center p-4 ">
          <h1> Pest Control in Toronto Beaches</h1>
          <p
            style={{
              color: "white",
              fontSize: "18px",
          ...
          >
            ...
            around your home or business in <b> Toronto Beaches</b>. We Guarantee removal of pest
             - If they return within given duration, we'll come back for free.
          </p>
          <a className="btn gs-btn mt-2" style={{ color: "white" }}  data-toggle="modal" data-target="#exampleModal">
            Contact Now
          </a>
        </div>
      </div>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-8">
              <h1>Remove Pests From Your Toronto Beaches's Home or Business</h1>
              <p>
              ...
              <p>
                ...
                by pests. Most bugs in Canada, particularly in <b>Toronto Beaches</b>,
                ...
                service. <b>Company Name</b> is one of <b>Toronto Beaches's</b> most
