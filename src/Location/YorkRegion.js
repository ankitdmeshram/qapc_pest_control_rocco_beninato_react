    ...
    <>
      <div className="breadcumb">
        <div className="text-center p-4 ">
          <h1> Pest Control in York Region</h1>
          <p
            style={{
              color: "white",
              fontSize: "18px",
          ...
          >
            ...
            around your home or business in <b> York Region</b>. We Guarantee removal of pest
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-8">
              <h1>Remove Pests From Your York Region's Home or Business</h1>
              <p>
              ...
              <p>
                ...
                by pests. Most bugs in Canada, particularly in <b>York Region</b>,
                ...
                service. <b>Company Name</b> is one of <b>York Region's</b> most
